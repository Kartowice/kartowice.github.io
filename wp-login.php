<!DOCTYPE html>
	...
	<title>wpmoney.kek &lsaquo; Войти</title>
	<link rel='stylesheet' href='http://wpmoney.kek/wp-admin/load-styles.php?c=1&amp;dir=ltr&amp;load%5B%5D=dashicons,buttons,forms,l10n,login&amp;ver=4.5.3' type='text/css' media='all' />
...
<meta name='robots' content='noindex,follow' />
	...
	<div id="login">
		<h1><a href="https://ru.wordpress.org/" title="Сайт работает на WordPress" tabindex="-1">wpmoney.kek</a></h1>
	
<form name="loginform" id="loginform" action="http://wpmoney.kek/wp-login.php" method="post">
	<p>
	...
	<p class="submit">
		...
		<input type="hidden" name="redirect_to" value="http://wpmoney.kek/wp-admin/" />
		<input type="hidden" name="testcookie" value="1" />
	</p>
</form>

<p id="nav">
	<a href="http://wpmoney.kek/wp-login.php?action=lostpassword">Забыли пароль?</a>
</p>
...
if(typeof wpOnload=='function')wpOnload();
	...
	<p id="backtoblog"><a href="http://wpmoney.kek/">&larr; Назад к сайту &laquo;wpmoney.kek&raquo;</a></p>
